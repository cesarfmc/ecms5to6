...
(function (root, factory) {
    ...
    var eventSplitter = [object Object];
    ...
    _.extend(Model.prototype, Events, {
        ...
        url: function () {
            ...
            if (this.isNew())
                return base;
            return base.replace([object Object], '$1/') + encodeURIComponent(this.id);
        },
    ...
    var delegateEventSplitter = [object Object];
    ...
    var optionalParam = [object Object];
    var namedParam = [object Object];
    var splatParam = [object Object];
    var escapeRegExp = [object Object];
    ...
    var routeStripper = [object Object];
    // Cached regex for stripping leading and trailing slashes.
    var rootStripper = [object Object];
    // Cached regex for stripping urls of hash.
    var pathStripper = [object Object];
    ...
    _.extend(History.prototype, Events, {
        ...
        atRoot: function () {
            var path = this.location.pathname.replace([object Object], '$&/');
            return path === this.root && !this.location.search;
        },
        // Gets the true hash value. Cannot use location.hash directly due to bug
        // in Firefox where location.hash will always be decoded.
        getHash: function (window) {
            var match = (window || this).location.href.match([object Object]);
        ...
        _updateHash: function (location, fragment, replace) {
            if (replace) {
                var href = location.href.replace([object Object], '');
